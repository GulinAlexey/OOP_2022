...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Text = L"Добавить заказ";
			...
			this->button4->Text = L"Список курьеров";
			...
			this->button5->Text = L"Список операторов";
			...
			this->button6->Text = L"Список администраторов";
			...
			this->button7->Text = L"Список денежных транзакций";
			...
			this->button8->Text = L"Список тарифов";
			...
			this->button9->Text = L"Список пени";
			...
			this->groupBox1->Text = L"Действия над заказами";
